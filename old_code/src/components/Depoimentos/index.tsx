...
export function Depoimentos() {
  const data = [
    {
      id: 1,
      autor: "José Moreira",
      cargo: "Diretor executivo da M. Dias Branco",
  ...
  return (
    <section className={styles.container} id="depoimentos">
      ...
      <div >
        {data?.filter(data => data.id === max ).map(data =>(
        <div className={styles.cardContainer} key={data.autor}>
            <div>
            ...
            <div className={styles.containerAutor}>
              <p>{data.autor}<br /> <span>{data.cargo}</span></p>
              <div className={styles.icons}>
                <button onClick={handleRm}>
                <i>
