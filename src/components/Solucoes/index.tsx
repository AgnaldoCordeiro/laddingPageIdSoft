    ...
    <div id="solucoes" className={styles.geral}>
      <section className={styles.container}>
        <div className={styles.titulo}>
          ...
          <p>
            A inteligência artificial é altamente versátil podendo ser
            utilizada em qualquer área
          </p>
        </div>
          ...
          <div className={styles.containerLinha}>
            <div className={styles.cardWrapper}>
              <CardImg
                height="300px"
                width="300px"
                title="Análise de dados para recomendações"
                img={group47}
                subTexto="Mecanismos de busca que combinam as preferências do usuário com histórico de dados a fim de indicar a melhor escolha."
              />
            </div>
            <div className={styles.cardWrapper}>
              <CardImg
                height="300px"
                width="300px"
                title="Diagnóstico de indicadores"
                img={group48}
                subTexto="A partir dos dados da empresa, verifique quais ações feitas estão dando resultados e quais os principais problemas que precisam ser resolvidos."
              />
            </div>
            <div className={styles.cardWrapper}>
            <CardImg
